...
! . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .
! .                                                                   .
! .   To assemble element stiff/mass into compacted global matrix     .
! .                                                                   .
...
SUBROUTINE ADDRHS(F, F_e, LM, ND)
  !------------------------------------------------------------
  ! Assembles equivalent nodal force vector into global load vector
  !
  ! Input:
  !   F_e(ND)  - Local equivalent nodal force vector
  !   LM(ND)   - DOF mapping from local to global
  !   ND       - Number of DOFs per element
  !
  ! In/Out:
  !   F(*)     - Global force vector (assembled)
  !------------------------------------------------------------
  USE GLOBALS, ONLY : NEQ
  IMPLICIT NONE
  INTEGER, INTENT(IN)    :: ND
  INTEGER, INTENT(IN)    :: LM(ND)
  REAL(8), INTENT(IN)    :: F_e(ND)
  REAL(8), INTENT(INOUT) :: F(NEQ)
...
! .        V(NN)     = Right-hand-side load vector (R+FK)             .
